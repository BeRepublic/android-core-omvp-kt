...
abstract class SampleInputActivityModule {
    ...
    @Binds
    @PerActivity
    internal abstract fun activity(activity: SampleInputActivity): Activity

    /**
     * The main activity listens to the events in the [SampleInputFragment].
     *
    ...
    @Binds
    @PerActivity
    internal abstract fun fragmentCallback(activity: SampleInputActivity): SampleInputFragment.FragmentCallback
     ...
     */
    @PerFragment
    @ContributesAndroidInjector(modules = arrayOf(SampleInputFragmentModule::class))
    internal abstract fun fragmentInjector(): SampleInputFragment
